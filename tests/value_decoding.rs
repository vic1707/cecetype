...
#[case::result_ok((Result::<u8, &str>::Ok(12), Value::Enum { enum_name: "Result".to_owned(), variant_name: "Ok".to_owned(), discriminant: 0, data: Data::NewType { field: Box::new(Value::U8(12)) } }))]
#[case::result_err((Result::<u8, &str>::Err("error"), Value::Enum { enum_name: "Result".to_owned(), variant_name: "Err".to_owned(), discriminant: 1, data: Data::NewType { field: Box::new(Value::Str("error".to_owned())) } }))]
...
#[case::unit_struct((UnitStruct, Value::Struct{ name: "UnitStruct".to_owned(), data: Data::Unit }))]
#[case::newtype_struct((NewTypeStruct(16), Value::Struct{ name: "NewTypeStruct".to_owned(), data: Data::NewType { field: Box::new(Value::U8(16)) } }))]
#[case::tuple_struct((TupleStruct(16, ()), Value::Struct{ name: "TupleStruct".to_owned(), data: Data::Tuple { fields: vec![Value::U8(16), Value::Unit] } }))]
#[case::generic_struct((GenericStruct(16u8), Value::Struct{ name: "GenericStruct".to_owned(), data: Data::NewType { field: Box::new(Value::U8(16)) } }))]
#[case::struct_((BasicStruct { a: 42, b: true }, Value::Struct{ name: "BasicStruct".to_owned(), data: Data::Struct { fields: vec![("a".to_owned(), Value::U32(42)), ("b".to_owned(), Value::Bool(true))] } }))]
#[case::enum_unit((BasicEnum::Unit, Value::Enum { enum_name: "BasicEnum".to_owned(), variant_name: "Unit".to_owned(), discriminant: 0, data: Data::Unit }))]
#[case::enum_tuple((BasicEnum::Tuple(10, false), Value::Enum { enum_name: "BasicEnum".to_owned(), variant_name: "Tuple".to_owned(), discriminant: 1, data: Data::Tuple { fields: vec![Value::U32(10), Value::Bool(false)] } }))]
#[case::enum_struct((BasicEnum::Struct { x: 1, y: 2 }, Value::Enum { enum_name: "BasicEnum".to_owned(), variant_name: "Struct".to_owned(), discriminant: 2, data: Data::Struct { fields: vec![("x".to_owned(), Value::U8(1)), ("y".to_owned(), Value::U8(2))] } }))]
#[case::generic_enum((GenericEnum::Toto(12u8), Value::Enum { enum_name: "GenericEnum".to_owned(), variant_name: "Toto".to_owned(), discriminant: 0, data: Data::NewType { field: Box::new(Value::U8(12)) } }))]
#[case::nested_struct((NestedStruct { inner: BasicStruct { a: 1, b: false }, tuple: (7, true), array: [1, 2, 3] }, Value::Struct{ name: "NestedStruct".to_owned(), data: Data::Struct { fields: vec![("inner".to_owned(), Value::Struct{ name: "BasicStruct".to_owned(), data: Data::Struct { fields: vec![("a".to_owned(), Value::U32(1)), ("b".to_owned(), Value::Bool(false))] } }), ("tuple".to_owned(), Value::Tuple(vec![Value::U32(7), Value::Bool(true)])), ("array".to_owned(), Value::Array(vec![Value::U8(1), Value::U8(2), Value::U8(3)]))] } }))]
#[case::enum_nested((BasicEnum::Nested { payload: NestedStruct { inner: BasicStruct { a: 9, b: true }, tuple: (3, false), array: [4, 5, 6] } }, Value::Enum { enum_name: "BasicEnum".to_owned(), variant_name: "Nested".to_owned(), discriminant: 3, data: Data::Struct { fields: vec![("payload".to_owned(), Value::Struct{ name: "NestedStruct".to_owned(), data: Data::Struct { fields: vec![("inner".to_owned(), Value::Struct{ name: "BasicStruct".to_owned(), data: Data::Struct { fields: vec![("a".to_owned(), Value::U32(9)), ("b".to_owned(), Value::Bool(true))] } }), ("tuple".to_owned(), Value::Tuple(vec![Value::U32(3), Value::Bool(false)])), ("array".to_owned(), Value::Array(vec![Value::U8(4), Value::U8(5), Value::U8(6)]))] } })] } }))]
...
#[case::duration((Duration::new(120, 500_000_000), Value::Struct{ name: "Duration".to_owned(), data: Data::Struct { fields: vec![("secs".to_owned(), Value::U64(120)), ("nanos".to_owned(), Value::U32(500_000_000))] } }))]
#[case::phantomdata((PhantomData::<()>, Value::Struct { name: "PhantomData".to_owned(), data: Data::Unit }))]
