...
#[case::result_ok((Result::<u8, &str>::Ok(12), Value::Enum { name: "Result".to_owned(), discriminant: 0, variant: VariantValue::NewType { name: "Ok".to_owned(), field: Box::new(Value::U8(12)) } }))]
#[case::result_err((Result::<u8, &str>::Err("error"), Value::Enum { name: "Result".to_owned(), discriminant: 1, variant: VariantValue::NewType { name: "Err".to_owned(), field: Box::new(Value::Str("error".to_owned())) } }))]
...
#[case::enum_unit((MyEnum::Unit, Value::Enum { name: "MyEnum".to_owned(), discriminant: 0, variant: VariantValue::Unit { name: "Unit".to_owned() } }))]
#[case::enum_tuple((MyEnum::Tuple(10, false), Value::Enum { name: "MyEnum".to_owned(), discriminant: 1, variant: VariantValue::Tuple { name: "Tuple".to_owned(), fields: vec![Value::U32(10), Value::Bool(false)] } }))]
#[case::enum_struct((MyEnum::Struct { x: 1, y: 2 }, Value::Enum { name: "MyEnum".to_owned(), discriminant: 2, variant: VariantValue::Struct { name: "Struct".to_owned(), fields: vec![("x".to_owned(), Value::U8(1)), ("y".to_owned(), Value::U8(2))] } }))]
#[case::generic_enum((GenericEnum::Toto(12u8), Value::Enum { name: "GenericEnum".to_owned(), discriminant: 0, variant: VariantValue::NewType { name: "Toto".to_owned(), field: Box::new(Value::U8(12)) } }))]
